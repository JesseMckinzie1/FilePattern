...
class StringPattern:
    def __init__(self, path: str, pattern: str, block_size: str=""):
        """Constructor of the StringPattern class. 
        
        StringPattern matches a pattern to string contained in a text file.Each line of the 
        text file is compared to the pattern and is captured if the string matches the pattern.
